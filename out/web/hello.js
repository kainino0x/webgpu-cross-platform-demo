...
// {{PRE_LIBRARY}}
  ...
  var WebGPU={buffers:{nextId:1,objects:[]}};function _dawnBufferMapReadAsync(bufferId, callback, userdata) {
  ...
  function _dawnBufferRelease(bufferId) {
